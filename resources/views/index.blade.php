                    ...
                    @foreach ($datas as $data)
                        <div class="col-sm-3">
                            <div class="single-item">
                                ...
                                <a href=""><img src="{{asset('assets/images/products/home_2/1.jpg')}}" alt=""></a>
                                </div>
                                <div class="single-item-body">
                                    <p class="single-item-title">{{$data->name}}</p>
                                    <p class="single-item-price">
                                        <span>Rp. {{number_format($data->price, 2)}}</span>
                                    </p>
                                </div>
                                <div class="single-item-caption">
                                    <a class="add-to-cart pull-left" href="shopping_cart.html"><i class="fa fa-shopping-cart"></i></a>
                                    <a class="beta-btn primary" href="{{route('user.show', ['id' => $data->id])}}">Details <i class="fa fa-chevron-right"></i></a>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
                        </div>
