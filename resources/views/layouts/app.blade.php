                            ...
                            <div class="cart">
                                ...
                                <div class="beta-dropdown cart-body">
                                    <div class="cart-item">
                                        ...
                                        <div class="media">
                                            <a class="pull-left" href="#"><img src="{{ asset('assets/images/products/cart/1.png') }}" alt=""></a>
                                    ...
                                    <div class="cart-item">
                                        ...
                                        <a class="cart-item-delete" href="#"><i class="fa fa-times"></i></a>
                                        <div class="media">
                                            <a class="pull-left" href="#"><img src="{{ asset('assets/images/products/cart/2.png') }}" alt=""></a>
                                            <div class="media-body">
                                                <span class="cart-item-title">Sample Woman Top</span>
                                                <span class="cart-item-options">Size: XS; Colar: Navy</span>
                                                <span class="cart-item-amount">1*<span>$49.50</span></span>
                                    ...
                                    <div class="cart-item">
                                        ...
                                        <a class="cart-item-delete" href="#"><i class="fa fa-times"></i></a>
                                        <div class="media">
                                            <a class="pull-left" href="#"><img src="{{ asset('assets/images/products/cart/3.png') }}" alt=""></a>
                                            <div class="media-body">
                                                <span class="cart-item-title">Sample Woman Top</span>
                                                <span class="cart-item-options">Size: XS; Colar: Navy</span>
                                                <span class="cart-item-amount">1*<span>$49.50</span></span>
