...
<div class="row">
    <div class="col-6">
        <div class="card">
            <div class="card-body">
                <form action="<?php echo e(route('admin.seller.update',['id' => $data->id])); ?>" class="" method="POST">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <input class="form-control" type="text" value="<?php echo e($data->email); ?>" name="email">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
