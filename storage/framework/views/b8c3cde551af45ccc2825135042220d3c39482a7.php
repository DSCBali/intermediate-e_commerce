...
<head>
    ...
    <!-- Custom CSS -->
    <link href="<?php echo e(asset('assets/admin/dist/css/style.min.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset('assets/admin/dist/css/main.css')); ?>" rel="stylesheet">
...
<body class="skin-default-dark fixed-layout">
    ...
    <div id="main-wrapper">
        ...
        <!-- ============================================================== -->
        <?php echo $__env->make('layouts.backend.sidebar', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        <!-- ============================================================== -->
    ...
    <script src="<?php echo e(asset('assets/admin/dist/js/perfect-scrollbar.jquery.min.js')); ?>"></script>
    <!--Wave Effects -->
    <script src="<?php echo e(asset('assets/admin/dist/js/waves.js')); ?>"></script>
    <!--Menu sidebar -->
    <script src="<?php echo e(asset('assets/admin/dist/js/sidebarmenu.js')); ?>"></script>
    <!--stickey kit -->
    ...
    <!--Custom JavaScript -->
    <script src="<?php echo e(asset('assets/admin/dist/js/custom.min.js')); ?>"></script>
